...
>
> ไม่รวมการวิเคราะห์ลำดับดีเอ็นเอ และไม่รวมการทดสอบทางสถิติ ปฏิบัติการนี้จบในตัวเองที่การนับ การสรุป และการสร้างกราฟ
...
**10.** จำนวนที่สังเกตได้ต่างจากจำนวนที่คาดหมายอยู่บ้าง ต่างกันมากพอที่จะสรุปว่าแบบจำลองผิดหรือไม่ คุณคิดว่าต้องใช้เครื่องมืออะไรเพิ่มจึงจะตอบคำถามนี้ได้
...
## 9. สิ่งที่ปฏิบัติการนี้รับผิดชอบ และสิ่งที่ยังตอบไม่ได้

ปฏิบัติการนี้หยุดที่การทำความสะอาดข้อมูล การนับ การสรุปด้วยสถิติพื้นฐาน และการสร้างกราฟ ซึ่งเป็นทักษะที่นำไปใช้ได้กับข้อมูลทุกชนิด ไม่จำกัดแค่พันธุศาสตร์
...
| นับฟีโนไทป์และเทียบกับค่าคาดหมายตามกฎเมนเดลได้ | ค่าที่ต่างจากค่าคาดหมายนั้น มากพอที่จะเรียกว่าผิดปกติหรือเป็นเพียงความบังเอิญ ซึ่งต้องใช้การทดสอบทางสถิติ |

**การรู้ว่าเครื่องมือที่ใช้อยู่ตอบอะไรได้และตอบอะไรไม่ได้ เป็นส่วนหนึ่งของการวิเคราะห์ข้อมูลที่ดีพอ ๆ กับการคำนวณให้ถูก**

**เก็บไฟล์ Workbook ที่ทำวันนี้ไว้ให้ดี**
